...
//    #warning Please define or replace the macro MY_DISP_HOR_RES with the actual screen height, default value 64 is used for now.
...
void lv_port_disp_init(void)
{
	...
	// static lv_color_t buf_1[MY_DISP_HOR_RES * BUFFER_ROW];                          /*A buffer for 10 rows*/
	//lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, NULL, MY_DISP_HOR_RES * BUFFER_ROW);   /*Initialize the display buffer*/
